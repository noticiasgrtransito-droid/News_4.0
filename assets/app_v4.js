...
(async function(){
  ...
  async function initApp(){
    ...
    const phones = [
      ...
      {"name":"Polícia Civil","site":"https://www.gov.br/policia-civil","tel":"181"},
      {"name":"Polícia Militar","site":"https://www.gov.br/policia-militar","tel":"190"},
      {"name":"SAMU","site":"https://www.gov.br/samu","tel":"192"},
      {"name":"PRF","site":"https://www.prf.gov.br","tel":"191"},
      {"name":"Defesa Civil","site":"https://www.gov.br/defesacivil","tel":"199"}
    ];
    ...
    // fetch feeds (mock + placeholder for RSS)
    async function fetchFeeds(){
      // try to load local mock first
